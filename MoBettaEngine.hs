...
boolCalc (Reln cOp expr1 expr2) = lift1 (lu cOp ReIn1) (intCalc expr1) (intCalc expr2)
boolCalc (BBin op expr1 expr2) =  lift1 (lu op BBin1) (boolCalc expr1) (boolCalc expr2)
boolCalc (BUn op expr) = fMap (lu op BUn1) (boolCalc expr)

intCalc :: AExpr -> IntCalc
intCalc (Var v) = retrieveEnv v
intCalc (IntConst val) = return val
intCalc (ABin op expr1 expr2) = lift1 (lu op BBin2) (intCalc expr1) (intCalc expr2)
intCalc (AUn op expr) = fMap (lu op BUn2) (intCalc expr)
